...
class BrokerApplicationPostResponseDto extends responses_1.SuccessResponseDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { loanAmount: { required: true, type: () => Number }, application: { required: true, type: () => Object } };
    }
}
